...
class ShoppingCart(models.Model):
    ...
    """
    #ForeignKey用于一对多
    #CASCADE，当主表的字段被删除时，和他有关的子表字段也会被删除
    name = models.ForeignKey(User,on_delete=models.CASCADE,verbose_name="用户")
    goods = models.ForeignKey(Goods,on_delete=models.Model,verbose_name='商品')
    ...
    def __str__(self):
        return "%s(%d)".format(self.goods.name,self.name)
